...
import { getSmartAuthPath, getBookingPath } from "@/utils/auth";
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Take a look at what our founder have to say about our mission and vision
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-white rounded-lg p-8 border flex flex-col items-center text-center"
              >
                <img
                ...
                <p className="text-gray-600 italic max-w-lg mb-6">
                  "{testimonial.content}"
                </p>
